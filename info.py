...
PICS = (environ.get('PICS', 'https://envs.sh/0L.jpg')).split()  # Sample pic
...
# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1002038041920")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-1002199891363")# Channels for force sub (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Help:Arise@cluster0.zf30oob.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB URI for the database
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/How_too_penlink")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/How_too_penlink")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/How_too_penlink")   # Third tutorial link for verification
...
MSG_ALRT = environ.get('MSG_ALRT', 'Share') # Alert message for users
